...
bot.remove_command('help') # Removing default help command to implement personalized help command. See /help.py.
...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Game(name='$help', type=1, url='')) # Sets status for Chitti
